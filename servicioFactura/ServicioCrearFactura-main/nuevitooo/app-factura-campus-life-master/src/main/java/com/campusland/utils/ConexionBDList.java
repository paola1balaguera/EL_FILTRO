...
/*     private void getLoadImpuestos() {
        listFacturas.add(new Impuesto());
        listFacturas.add(new Impuesto());
        listFacturas.add(new Impuesto());
    } */
...
/*     private void getLoadImpuestos() {
        listFacturas.add(new Cliente("Juan", "Perez", "jperez@gmail.com", "dirección", "celular", "13822001"), new Factura());
        listFacturas.add(new Impuesto());
        listFacturas.add(new Impuesto());
    } */
